...
class StableDiffusionGuidance(BaseObject):
    ...
    class Config(BaseObject.Config):
        ...
        # a trick to resclae the camera to world postition
        c2w_scale: float = 1.0
    ...
    def configure(self) -> None:
        ...
        threestudio.info(f"Loading NOCSUNet ...")
        ...
        threestudio.info(f"Loaded NOCSUNet!")
        ...
        **kwargs,
        ...
        if not is_cmm:
            grad, guidance_eval_utils = self.compute_grad_sds(
                latents, t, prompt_utils, elevation, azimuth, camera_distances, rescale=rescale
            )
        else:
            camera_condition = c2w
            # convert to cmm coordinate
            ...
            grad, guidance_eval_utils = self.compute_cmm_grad_sds(
        ...
        if not is_cmm:
            ...
            guidance_out['loss_cmm_sds'] = loss_sds
