...
class CameraEmbedding(nn.Module):
    ...
    def forward(self, camera2world: torch.FloatTensor):
        return self.models(camera2world)
...
class MyUNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def forward(
        ...
        camera2world: torch.Tensor = None,
        ...
        if camera2world is not None:
            camera_emb = self.camera_embedding(camera2world)
            aug_emb = camera_emb
        else:
            aug_emb = None
